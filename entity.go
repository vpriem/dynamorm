...
type Entity interface {
	...
	// During a Save() operation it is called and saves the values respectively in PK/SK columns.
	...
	// During a Save() operation it is called and saves the values respectively in GSI1PK/GSI1SK columns.
	...
	// During a Save() operation it is called and saves the values respectively in GSI2PK/GSI2SK columns.
	// Return empty strings if not using this GSI.
	GSI2() (string, string)
